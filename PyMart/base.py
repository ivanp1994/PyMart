    ...
    def _get_config_xml(self):
        ...
        if 'text/html' in content_type:
            ...
            if "Service Unavailable" in html_content or "Error" in html_content:
                raise ServiceUnavailableError("The service is temporarily unavailable. Received HTML response: " + html_content)
            raise ServiceUnavailableError("Unexpected HTML response received: " + html_content)
